 ...
 //  alert(JSON.stringify(localStorage.getItem('token'), null, 2));
  ...
  >
    ...
    <Modal {...props}  size="md">
      <div className={styles.custModal}>
        ...
        <Form id="loginForm" method="POST" onSubmit={handleSubmit}>
          ...
          <Form.Group controlId="loginUser">
            ...
            <Form.Control type="text" name="log" onChange={handleChange}
              onBlur={handleBlur}
              value={values.log}
              className={touched.log && errors.log ? styles.haserror : null}/>
          ...
          <Form.Group controlId="loginPassword">
            ...
            <Form.Control type="password" name="pass" onChange={handleChange}
              onBlur={handleBlur}
              value={values.pass}
              className={touched.pass && errors.pass ? styles.haserror : null}/>
      ...
      {  (!auth) ? <p className={styles.formInvalid}>{err}</p> : <p className={styles.formValid}>{err}</p>}
